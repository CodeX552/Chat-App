        ...
        {messagesDummyData.map((msg, index) => (
          <div key={index} className={`flex items-end gap-2 justify-end ${msg.senderId !== '680f50e410f3cd28382ecf9' ? 'flex-row-reverse' : ''}`}>
            {msg.image ? (
              ...
              <p className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg mb-8 break-all text-white ${msg.senderId === '680f50e410f3cd28382ecf9' ?  'rounded-br-none' : 'rounded-bl-none'}`}>{msg.text}</p>
            )}
